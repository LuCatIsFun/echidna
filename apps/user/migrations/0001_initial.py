    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', '普通用户'), ('admin', '管理员')], default='user', max_length=30, verbose_name='用户角色')),
                ...
                ('dead_date_time', models.DateTimeField(default=datetime.datetime(2020, 10, 24, 18, 36, 51, 243728), verbose_name='最长可用时间')),
